...
public sealed class DatabaseCutoverSafetyContractTests
{
    ...
    {
        var prepareSql = DatabaseSchemaScripts.BuildUpgradeSql(10, "1.1.0");
        var finalizeSql = DatabaseSchemaScripts.BuildFinalizeSql(10, "1.1.0");
        ...
        Assert.Contains("Version = 10", finalizeSql, StringComparison.Ordinal);
    }
    ...
    [Fact]
    public void Sql_write_gate_rejects_legacy_or_unregistered_clients_and_accepts_schema_ten()
    {
        var sql = DatabaseSchemaScripts.BuildFinalizeSql(10, "1.1.0");
