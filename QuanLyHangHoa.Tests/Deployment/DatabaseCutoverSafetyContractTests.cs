...
public sealed class DatabaseCutoverSafetyContractTests
{
    ...
    {
        var prepareSql = DatabaseSchemaScripts.BuildUpgradeSql(9, "1.1.0");
        var finalizeSql = DatabaseSchemaScripts.BuildFinalizeSql(9, "1.1.0");
        ...
        Assert.Contains("Version = 9", finalizeSql, StringComparison.Ordinal);
    }
    ...
    [Fact]
    public void Sql_write_gate_rejects_legacy_or_unregistered_clients_and_accepts_schema_nine()
    {
        var sql = DatabaseSchemaScripts.BuildFinalizeSql(9, "1.1.0");
