...
public sealed class DatabaseCutoverSafetyContractTests
{
    ...
    {
        var prepareSql = DatabaseSchemaScripts.BuildUpgradeSql(11, "1.1.0");
        var finalizeSql = DatabaseSchemaScripts.BuildFinalizeSql(11, "1.1.0");
        ...
        Assert.Contains("Version = 11", finalizeSql, StringComparison.Ordinal);
    }
    ...
    [Fact]
    public void Sql_write_gate_rejects_legacy_or_unregistered_clients_and_accepts_schema_eleven()
    {
        var sql = DatabaseSchemaScripts.BuildFinalizeSql(11, "1.1.0");
