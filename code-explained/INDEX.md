...
| [Quan hệ cơ sở dữ liệu dễ hiểu](./03-code/15_quan_he_co_so_du_lieu_de_hieu.md) | FK vật lý/logic, cardinality, serial, hóa đơn, bảo hành và audit archive |
...
- [Giải thích sơ đồ](./01-overview/diagrams_explained.md): ý nghĩa và cách đọc các sơ đồ của hệ thống.
