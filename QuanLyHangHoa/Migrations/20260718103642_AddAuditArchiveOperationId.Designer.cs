...
namespace QuanLyHangHoa.Migrations
{
    ...
    [Migration("20260718103642_AddAuditArchiveOperationId")]
    partial class AddAuditArchiveOperationId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.AuditArchiveManifest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.ProductSerial", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId", "CurrentWarehouseId", "CurrentStatus" }, "IX_ProductSerial_Product_Warehouse_Status");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.PurchaseInvoice", b =>
                {
                    ...
                    b.HasIndex(new[] { "PaymentStatus", "InvoiceDate" }, "IX_PurchaseInvoice_PaymentStatus_InvoiceDate");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.SalesInvoice", b =>
                {
                    ...
                    b.HasIndex(new[] { "PaymentStatus", "InvoiceDate" }, "IX_SalesInvoice_PaymentStatus_InvoiceDate");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.StockIn", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "IX_StockIn_CreatedAt");

                    b.HasIndex(new[] { "ImportDate" }, "IX_StockIn_ImportDate");

                    b.HasIndex(new[] { "Status", "ImportDate" }, "IX_StockIn_Status_ImportDate");
                    ...
                    b.ToTable("StockIn", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockIn_PurposeCode", "[PurposeCode] IN ('Purchase', 'OpeningBalance', 'Adjustment', 'WarrantyReceive')");
                        });
                });
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.StockOut", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "IX_StockOut_CreatedAt");

                    b.HasIndex(new[] { "CustomerId" }, "IX_StockOut_CustomerId");

                    b.HasIndex(new[] { "ExportDate" }, "IX_StockOut_ExportDate");

                    b.HasIndex(new[] { "Status", "ExportDate" }, "IX_StockOut_Status_ExportDate");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.WarrantyClaim", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductSerialId" }, "IX_WarrantyClaim_ProductSerialId");

                    b.HasIndex(new[] { "Status" }, "IX_WarrantyClaim_Status");
            ...
            modelBuilder.Entity("QuanLyHangHoa.Models.AuditArchiveManifest", b =>
                {
                    b.HasOne("QuanLyHangHoa.Models.AppUser", "Actor")
                        .WithMany()
