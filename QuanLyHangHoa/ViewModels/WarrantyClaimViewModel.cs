...
{
    public partial class WarrantyClaimViewModel : ObservableObject
    {
        ...
        public WarrantyClaimViewModel(AppUser currentUser, AppDbContext dbContext)
            : this(
                currentUser,
