...
**Status (2026-08-03):** Complete and merged to `main` at `963281c`.

**Verified result:** 904 tests passed, 0 failed, 15 existing integration skips; solution build passed with 0 warnings and 0 errors.

**Scope note:** `TEST_EVIDENCE.md` stayed untracked and untouched. No thesis/DOCX/PDF artifact was modified.
...
- [x] **Step 1: Add interceptor support to the existing context helper**
...
- [x] **Step 2: Add the smallest shared counter**
...
- [x] **Step 3: Compile the helper change**
...
- [x] **Step 4: Commit the test infrastructure**
...
- [x] **Step 1: Write red stock-in query-count test**
...
- [x] **Step 2: Run the stock-in test and confirm the N+1 failure**
...
- [x] **Step 3: Batch stock-in products and serials**
...
- [x] **Step 4: Run stock-in tests green**
...
- [x] **Step 5: Write red stock-out query-count test**
...
- [x] **Step 6: Run the stock-out test and confirm the N+1 failure**
...
- [x] **Step 7: Batch stock-out products and serials**
...
- [x] **Step 1: Write and run the red transfer query-count test**
...
- [x] **Step 2: Batch transfer products**
...
- [x] **Step 3: Run transfer tests green**
...
- [x] **Step 4: Write and run the red reversal query-count test**
...
- [x] **Step 5: Batch reversal balances**
...
- [x] **Step 6: Run reversal tests green**
...
- [x] **Step 7: Commit transfer and reversal changes**
...
- [x] **Step 1: Add a shared measurement helper inside the existing test class**
...
- [x] **Step 2: Write red category and product import tests**
...
- Query-count coverage now verifies stock-in, stock-out, transfer, reversal, Dynamic Import master data, serials, stock documents, invoices, and invoice replay.
- Services use batch `Contains` queries plus in-memory dictionaries, sets, or tracked EF collections; no public API, schema, authorization, audit, idempotency, or transaction boundary changed.
- Commits merged to `main`: `b854968`, `f2581fe`, `dc45cfa`, `6acb804`, `963281c`.
- Full verification on `main` on 03/08/2026: 904 passed, 0 failed, 15 existing skips; build 0 warnings, 0 errors.

## Handoff

See `docs/handoffs/SESSION_HANDOFF_2026-08-03.md` for current repository state and next-session guidance.
...
- [x] **Step 4: Batch category upserts**
...
- [x] **Step 5: Batch product and reference resolution**
...
- [x] **Step 6: Batch product-serial note updates**
...
- [x] **Step 7: Batch replay verification for master data and serials**
...
- [x] **Step 8: Run focused and existing dynamic-import tests**
...
- [x] **Step 9: Commit master-data import changes**
...
- [x] **Step 1: Write red transactional import query-count tests**
...
- [x] **Step 2: Run the tests and confirm linear growth**
...
- [x] **Step 3: Batch stock-in document data**
...
- [x] **Step 4: Batch stock-out document data**
...
- [x] **Step 5: Batch purchase and sales invoice data**
...
- [x] **Step 6: Batch replay verification for documents and invoices**
...
- [x] **Step 7: Prove no query remains inside an import row/serial loop**
...
- [x] **Step 8: Run the complete dynamic-import test class**
...
- [x] **Step 9: Commit transactional import changes**
...
- [x] **Step 1: Run all tests without restoring**
